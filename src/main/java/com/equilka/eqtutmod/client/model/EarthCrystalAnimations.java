...
public class EarthCrystalAnimations {
        public static final AnimationDefinition ACTIVE = AnimationDefinition.Builder.withLength(4.0F).looping()
                ...
                .addAnimation("chunks1", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("chunks2", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
        ...
        public static final AnimationDefinition UNACTIVE = AnimationDefinition.Builder.withLength(4.0F).looping().build();
}
